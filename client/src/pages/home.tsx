  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.phone || !formData.email || !formData.service) {
      toast({
        ...
        description: "Please fill in all fields to get your free quote.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const response = await fetch('/api/admin/contacts', {
        ...
        body: JSON.stringify({
          ...
          message: `Free Quote Request - Service: ${formData.service}`,
              ...
              <div className="lg:justify-self-end slide-up">
                <div className="bg-white rounded-3xl p-8 shadow-2xl max-w-md">
                  ...
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <Button 
                      type="submit"
                      className="w-full hvac-button-primary text-lg py-3"
