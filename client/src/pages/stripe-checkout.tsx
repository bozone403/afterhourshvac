  ...
  if (!stripePromise) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="text-center p-8">
            <h2 className="text-xl font-semibold mb-2 text-red-600">Payment Unavailable</h2>
            <p className="text-gray-600 mb-4">Stripe payment processing is not configured. Please contact support.</p>
            <Button asChild>
