        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="windowArea" className="text-white/90">Window Area (sq ft)</Label>
                  <Input className="bg-white/5 backdrop-blur-sm border-white/20 text-white placeholder:text-white/40 focus:border-amber-500"
                    id="windowArea"
                    type="number"
                    placeholder="e.g., 200"
                ...
                <div className="space-y-2">
                  <Label htmlFor="occupancy" className="text-white/90">Number of Occupants</Label>
                  <Input className="bg-white/5 backdrop-blur-sm border-white/20 text-white placeholder:text-white/40 focus:border-amber-500"
                    id="occupancy"
                    type="number"
                    placeholder="e.g., 4"
          ...
          {results && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Equipment Recommendations</h3>
              ...
              <Card className="bg-gradient-to-r from-orange-500 to-blue-600 text-white">
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <Button variant="secondary" className="bg-white text-white hover:bg-gray-100">
