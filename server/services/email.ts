import { insertContactSubmissionSchema, insertEmergencyRequestSchema } from "@shared/schema-sqlite";

type InsertContactSubmission = typeof insertContactSubmissionSchema._type;
type InsertEmergencyRequest = typeof insertEmergencyRequestSchema._type;
