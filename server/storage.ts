import { users, hvacEquipment, hvacMaterials, hvacAccessories, emergencyRequests, jobApplications, enhancedQuotes, proCalculatorQuotes, jobSchedules, maintenancePlans, teamMembers, contactSubmissions, quoteRequests, serviceBookings, customers, blogPosts } from "@shared/schema-sqlite";
...
export class DatabaseStorage implements IStorage {
  ...
  constructor() {
    // Use memory store for SQLite build instead of PostgreSQL session store
